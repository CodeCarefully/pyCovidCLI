...
if arguments["--countries"] is None:
    arguments["--countries"] = ("Israel", "Estonia", "United States", "Italy", "Spain", "Netherlands", "India", "Canada", "China")
else:
...
if response==None and not arguments["--cacheoff"]:
...
for country in csvreader:
    if country[2] in arguments["--countries"] and country[4] != "": #second test there makes sure we don't have an incomplete day
